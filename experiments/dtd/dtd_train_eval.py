...
from experiments.dtd.q_model import ResNet18, MobileNetV2,ResNet50
from experiments.utils import adjust_learning_rate, progress_bar, quant_args_parser
from experiments.dtd.utils import data_generator
...
def train_model(args, device):
    ...
    wandb.init(project="DTD-QAT8", entity="mhussein") 
...
def args_parser():
    parser = argparse.ArgumentParser(description='PyTorch Quantization Training for DTD')
