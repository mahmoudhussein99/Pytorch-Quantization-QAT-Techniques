...
#          sbatch job_ault.sbatch "python3 cifar_train_eval.py  --seed ${SEED} --act_qmode ${AS} --act_bits 4  --weight_qmode ${WS} --weight_bits 4  --shortcut_quant False --model ${ARCH}"
#            done done done
...
#for SEED in "${seeds[@]}"; do
#    for ES in "${error_scheme[@]}"; do
#          sbatch job_ault.sbatch "python3 cifar_train_eval.py  --seed ${SEED} --act_qmode lsq_act --act_bits 4  --weight_qmode dorefa_weight --weight_bits 4 --error_qmode ${ES} --error_rounding nearest --error_man 2 --error_sig 5 --error_rep fp --shortcut_quant False --error_scale 1000000.0 --model ${ARCH}"
#          done done
