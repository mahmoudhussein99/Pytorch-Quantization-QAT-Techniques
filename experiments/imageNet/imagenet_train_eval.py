...
from experiments.utils import get_q_modules, str2bool, get_bn_modules, get_first_layer_modules, quant_args_parser
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if not args.multiprocessing_distributed or (args.multiprocessing_distributed
       ...
       # wandb.init(project='state_quantization_neurips22', entity='saleh_projects')
        wandb.init(project="ImageNet-Resnet18-FullAcc", entity="mhussein")
