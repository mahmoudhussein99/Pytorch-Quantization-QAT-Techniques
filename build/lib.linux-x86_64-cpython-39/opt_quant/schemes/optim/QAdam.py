...
class QAdam(Optimizer, QuantizeBase):
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p, exp_avgs_buffer, exp_avg_sqs_buffer in zip(params_with_grad, exp_avgs, exp_avg_sqs):
                ...
                state['exp_avg'] = self.quant_fun(exp_avgs_buffer / exp_avgs_buffer_scale, bits=self.bitwidth, **self.bitwidth_kwargs) * exp_avgs_buffer_scale
                state['exp_avg_sq'] = self.quant_fun(exp_avg_sqs_buffer / exp_avg_sqs_buffer_scale, bits=self.bitwidth, **self.bitwidth_kwargs) * exp_avg_sqs_buffer_scale
